...
public class LibraryMain extends javax.swing.JFrame {
  ...
  private void preencherTabela() {
    ...
    switch (criterio) {
        case "Ultimos":
            books.sort((b1, b2) -> Integer.compare(b2.getCodigo(), b1.getCodigo())); 
            break;
        case "Lançamento":
            books.sort((b1, b2) -> Integer.compare(b2.getAno(), b1.getAno())); 
            break;
        case "Usuario":
            books.sort((b1, b2) -> b1.getUsuario().compareTo(b2.getUsuario())); 
            break;
        case "Alfabetico":
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jLabel1)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(User, javax.swing.GroupLayout.PREFERRED_SIZE, 57, Short.MAX_VALUE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
